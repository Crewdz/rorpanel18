		...
		function updateServerStatus(num)
		{
			if(num=="0")
			{
				document.getElementById("statusImg").src = "img/status/close.png";
				document.getElementById("statusText").innerHTML = "Server is Offline";
			}
			else if(num=="2")
			{
				document.getElementById("statusImg").src = "img/status/tick.png";
			...
			else if(num=="serverlist")
			{
				...
				document.getElementById("statusImg").src = "img/infonew.png";
		...
		function addRow(name) {
			...
			var data = '<div id="row_'+num+'" class="serverlist_row"> \
							<div class="serverlist_statusfield" onClick="javascript: window.location.href = \'?server='+name+'&action=server_control\';"> \
								<img class="serverlist_statusimg" id="status_'+num+'" src="img/status/rolling.gif" height="25" title="This server is offline" /> \
								<span class="serverlist_namefield">'+name+'</span> \
							</div> \
							<div class="serverlist_actionfield"> \
								<img  src="img/srch.png"     height="25" title="View this server in more detail"  onClick="javascript: window.location.href = \'?server='+name+'&action=server_control\';" /> \
								<img  src="img/copy.png" height="25" title="Copy this server configuration"   onClick="javascript: copyServer('+num+', \''+name+'\');" /> \
								<img  src="img/garbage.png"      height="25" title="Delete this server configuration" onClick="javascript: deleteServer('+num+', \''+name+'\');" /> \
							</div> \
						</div> \
			';
