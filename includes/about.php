...
<fieldset style="text-align: left;">
	...
	<ul>
		<li><strong>Admin panel</strong><br /><span style="margin-left: 25px;">neorej16 (neorej16@rigsofrods.com)</span><br>
		<span style="margin-left: 25px;">Crewdz (Discord: Crewdz#6243)</span><br>
		<span style="margin-left: 25px;">Lexman02 (Discord: Lexman02#1242)</span><br>
		<span style="margin-left: 25px;">AndrewTech (Discord: AndrewTech#2186)</span>
		</li>
		<li><strong>Flat Icon</strong><br /><span style="margin-left: 25px;">https://www.flaticon.com/</span></li>
		<li><strong>Font Awesome</strong><br /><span style="margin-left: 25px;">https://fontawesome.com/</span></li>
		<li><strong>JavaScript Secure Hash Algorithm (SHA1)</strong><br /><span style="margin-left: 25px;">http://www.webtoolkit.info</span></li>
		<li><strong>Bulma</strong><br /><span style="margin-left: 25px;">https://bulma.io/</span></li>
		<li><strong>Bootstrap</strong><br /><span style="margin-left: 25px;">https://getbootstrap.com/</span></li>
	</ul>
</fieldset>
<fieldset style="text-align: left;">
