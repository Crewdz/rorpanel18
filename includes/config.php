...
<form method="post" action="$url[current]">
	...
	<textarea name="cfgtxt" id="cfgtxt" style="height: 500px; width: 600px;">$mycontent</textarea><br />
	
	<input class="button is-large is-link is-fullwidth" type="submit" name="submit" id="submit" value="Submit Changes" style="width: 100%; height: 50px;" />
