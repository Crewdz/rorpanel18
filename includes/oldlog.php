...
// Create the output
$title = 'old logbooks';				
$content = '<div style="width: 100%; text-align: center; font-style: italic; color: grey;">'.date("d M Y H:i:s").'</div><div style="width: 100%; margin: 0; padding: 0; text-align: center;">';
$content .= <<<EOF
